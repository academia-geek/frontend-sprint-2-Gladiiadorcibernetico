    ...
    return (
        <div>
           ...
           <Div24>
               ...
               <h6>{email} </h6>
               {showImputMail && <input type="text" name= "email" value={datosForm.email} onChange={handleOnChange} /> }
               <ButtonF onClick={()=>  setShowImputMail(!showImputMail)  }> Edit</ButtonF>
           </Div24>
           ...
           <Div24>
               ...
               <h6>{phone} </h6>
               {showImputPhone && <input type="text" name= "phone" value={datosForm.phone} onChange={handleOnChange} /> }
               <ButtonG onClick={()=>  setShowImputPhone(!showImputPhone)  }> Edit</ButtonG>
           </Div24>
